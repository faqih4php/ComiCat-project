    ...
    <div class="authentication-inner row m-0">
      ...
      <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center p-5">
        <div class="w-100 d-flex justify-content-center">
          <img src="/assets/img/illustrations/cat-with-a-book.png" class="img-fluid" alt="Login image" width="700" data-app-dark-img="illustrations/cat-with-a-book.png" data-app-light-img="illustrations/cat-with-a-book.png">
        </div>
      </div>
      <!-- /Left Text -->
