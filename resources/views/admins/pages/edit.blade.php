    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header border-bottom mb-4 d-flex justify-content-between align-items-center">
                <h5 class="card-title mb-0">Edit Pages to Chapter {{ $chapter->chapter_number }}</h5>
                <div>
            ...
            <div class="card-body">
                ...
                <form action="{{ route('chapters.pages.update', ['chapter' => $chapter, 'page' => $page]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <div class="col-12 mb-3">
                            ...
                            <input type="file" class="form-control @error('images') is-invalid @enderror" id="images"
                                name="images[]" value="{{ old('images', $page->image) }}" accept="image/*" multiple required>
