        ...
        <div class="card">
            ...
            <div class="card-body pb-0">
                ...
                <div class="card-actions d-flex">
                    <a href="{{ route('roles.create') }}" class="btn btn-primary ms-auto">Tambah Role</a>
                </div>
            </div>
                                ...
                                <td>
                                    <div class="d-flex gap-2" aria-label="Basic example">
                                        <a href="{{ route('roles.edit', $role->id) }}" class="btn btn-warning"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit roles">
                                            <i class="fa-solid fa-edit"></i>
                                        </a>
                                        <a href="{{ route('roles.show', $role->id) }}" class="btn btn-info"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Show roles">
                                            <i class="fa-solid fa-eye"></i>
                                        </a>
                                        <a href="{{ route('roles.destroy', $role->id) }}" class="btn btn-danger"
                                            data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Hapus roles">
